...
const style = {
	...
	h1: `text-5xl md:text-6xl lg:text-6xl text-white`,
	h3: `mb-[1em] mt-[0.25em] underline decoration-indigo-500 text-white text-3xl md:text-3xl lg:text-4xl italic text-slate-100`,
	container_for_small: `flex justify-center items-center`,
	small_container: `flex flex-col justify-center items-center`,
	button_icon: `border text-5xl md:text-5xl h-[100%] md:h-[100%] lg:h-[100%] p-0 md:p-1 lg:p-4`,
