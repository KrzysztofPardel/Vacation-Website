...
const style = {
	...
	container_left_: `h-[55vh] md:h-[60vh] lg:h-[40rem] w-[90vw] md:m-10 md:m-10 md:mx-auto mb-[3rem] p-10 bg-slate-200/70 rounded-3xl`,
	container_right_: `flex flex-col h-[55vh] md:h-[70vh] lg:h-[40rem] w-[80vw] md:w-[55vw] mx-auto p-10 bg-slate-200/70 rounded-3xl text-center mb-[3rem]`,
	...
	component_container: `max-w-[60rem] md:w-[50vw] lg:w-[50vw] h-[15rem] md:h-[20rem] lg:h-[23rem] mx-auto m-4 border-2 border-grey-300 bg-slate-100/60 rounded-xl bg-gradient-to-r from-[var(--primary-dark)] via-green-300 to-[var(--primary-light)] p-1`,
