...
const style = {
	background: `object-cover -z-10 absolute w-[100vw] h-[60rem] md:h-[35rem] md:h-[55rem] opacity-40`,
	container_all_: `flex justify-between items-center h-[60rem] md:h-[35rem] md:h-[55rem] p-5 md:p-10 lg:p-20 mt-[1rem]`,
