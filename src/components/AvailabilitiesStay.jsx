...
const style = {
	background: `object-cover -z-10 absolute w-[100vw] h-[55rem] md:h-[55rem] opacity-40`,
	...
	container_small: `flex justify-center flex-col md:flex-row py-2 w-[100%]`,
	...
	input_container: `flex flex-col md:flex-row justify-start gap-[5%] w-[100%]`,
	label: `flex md:justify-center md:justify-start py-2 font-medium`,
	inputs: `border p-2 md:p-3 w-[15rem] md:w-[15rem] lg:w-[17rem] xl:w-[20rem] rounded-lg`,
