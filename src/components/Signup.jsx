...
const style = {
	...
	container_right: `h-[65vh] flex flex-col justify-start items-center max-w-[700px] mx-auto m-10 p-10 bg-slate-200/70 rounded-3xl text-center`,
			...
			<div className='relative'>
				...
				<div className={style.container_all}>
					...
					<div className={style.container_right}>
						...
						<div className='w-[100%] flex flex-row-reverse justify-start  items-center mb-5'>
							<button>
